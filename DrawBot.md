...
<p><a href="http://nodebox.net">NodeBox</a> is a project based on Just Van Rossum's DrawBot. NodeBox allows you to create PDF documents using Python-code. NodeBox, which is available for free, is currently used as a teaching and experimentation environment. Pretty soon we are planning to move cross-platform and server-side. Somewhat later on we'll be extending NodeBox with a node-based user interface, which has always been the original goal, and all of the ARTI (ARTifical Intelligence) we are currently working on. NodeBox can be used as a professional package as well, one that generates documents that are press-ready.</p>

<p>One last step would be to make NodeBox <em>plugable</em>, with a back-end and front-end that could be switched. There are some notes on the future of NodeBox on the <a href="http://blog.nodebox.net/">blog</a>.</p>
...
<p>Programmin Python is relatively easy, so NodeBox is an excellent environment to confront design students with a way of designing unknown to them. Most design students at St. Lucas Antwerp run into NodeBox at a certain point.</p>

<h1>Examples</h1>

<p>There are some examples of NodeBox's capacities at the <a href="http://nodebox.net/code/index.php/Gallery]](NodeBox Gallery">http://nodebox.net/code/index.php/Gallery]](NodeBox Gallery</a>. Also, every year there is a type and technology workshop at the Lahti Institute of Design, Finland, where Lucas Nijs confronts students with typography and NodeBox.</p>

<p>In 2004 for example they were asked to design a 730-page book using NodeBox, results can be viewed <a href="http://lahti.grafitron.com/2004">here</a>.</p>

<p><br />
<span class="media"><img src="/static/media/nodebox.gif" width="69" height="80" alt="" /></span>
</p>
